...
salt_1 = raw_input("First, type a random and arbitrary string of characters"
                   "to act as a hashing"
                   " salt: ")

salt_2 = raw_input("Now, choose another random and arbitrary string to act as"
                   "a second salt: ")
...
print "Thanks! Now we'll just install the necessary packages and have your" \
      "environment ready in no time!"
